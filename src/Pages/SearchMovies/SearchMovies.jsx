...
export default function SearchMovies() {
  ...
  return (
    <div>
      <SideBar />
      <div className="bg-black min-h-screen p-6 text-white w-5/6 float-right">
        {loading ? (
          ...
          DataList.map((video, index) => (
            <div
              key={index}
              className="flex items-start gap-4 mb-6 cursor-pointer hover:bg-zinc-900 transition-all duration-300 p-3 rounded-xl"
